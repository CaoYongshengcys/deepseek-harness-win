...
declare module '@deepseek-ai/dsh-client-ui-slots' {
  interface SlotMap {
    ...
    /**
     * The workspace-files browsing region, shown when the shell's view toggle
     * selects it in place of the session list. Declared by this package's
     * 'sidebar' entry; ui-files registers the file tree panel. The shell hands
     * it the same column state as the workspace browser.
     */
