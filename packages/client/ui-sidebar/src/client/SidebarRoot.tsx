...
export function SidebarRoot({
  ...
  // Browsing view: the session list or the workspace file tree. Shell-local —
  // the rail always shows the session list, and the toggle renders only wide.
  ...
  return (
    ...
    >
      ...
      {/* Wide-only view switch between the session list and the workspace
          file tree; the rail keeps the session list. */}
      {wide && (
        <div className={css.viewToggle}>
          <button
            type="button"
            className={clsx(css.viewTab, view === 'sessions' && css.viewTabActive)}
      ...
      {/* The browsing region fills the column between the controls and the
          ...
          wide file view replaces the session list while selected. */}
